$(document).ready(function() {
  ...
  $('a.blog-button').click(function() {
	if ($('.btn-mobile-menu').css('display') == 'block'){
	   $('.panel-cover').height('auto');
	}
    ...
    if (currentWidth < 960) {
      ...
      $('.panel-cover').animate({'max-width': '455px', 'width': '26%'}, 400, swing = 'swing', function() {} );
    }
  });
  ...
  $('.navigation-wrapper .blog-button').on('click',function(e) {
